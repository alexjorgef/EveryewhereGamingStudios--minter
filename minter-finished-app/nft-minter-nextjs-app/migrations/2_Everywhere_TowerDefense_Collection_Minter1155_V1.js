...
console.log('_Everywhere_TowerDefense_Collection_Minter1155_V1');
console.log('=====================================================');
...
module.exports = async (deployer, network, accounts) => {
    ...
    try {
        const cm = await _Everywhere_TowerDefense_Collection_Minter1155_V1.deployed();
        console.log('_Everywhere_TowerDefense_Collection_Minter1155_V1 already deployed: ', cm.address);
    } catch (e) {
        const instance = await deployProxy(
            _Everywhere_TowerDefense_Collection_Minter1155_V1,
            {
